...
urinary_prompts = [
    "The primary organ(s) of the urinary system is/are: \n(a)the liver\n(b )the kidneys\n(c) the pancreas\n(d) the gallbladder\n",
    "True or False:\nThe urinary system is also known as the renal system.\n",
    ...
    "Which of the following are NOT diseases of the urinary system?\n(a) Interstitial cystitis\n(b) Arteriosclerosis\n(c)Kidney Stones\n(d) Urinary tract infections\n\n",
    "True or False:\nNephrologists treat problems with the urinary tract.\n"
]

# need to come up with incorrect answers for the multiple choice questions
# 1-B, 2-T, 3-C, 4-F- (1/2 liter), 5-D, 6-T, 7-B, 8-T, 9-B, 10-F (nephrologists)
